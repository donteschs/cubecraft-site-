...
const plans = [
  {
    ...
    features: ["100 cubes magnétiques", "8 couleurs vives", "Pochette de rangement", "20 modèles d'inspiration", "Accès communauté CubeCraft", "Certifié CE & EN 71"],
    cta: "Choisir ce pack",
    highlight: false,
    badge: null,
  ...
  },
  {
    ...
    features: ["200 cubes magnétiques", "8 couleurs vives", "Pochette de rangement XL", "20 modèles d'inspiration", "Accès communauté CubeCraft", "Certifié CE & EN 71", "Emballage cadeau premium"],
    cta: "Choisir ce pack",
    highlight: true,
  ...
  },
  {
    ...
    features: ["400 cubes magnétiques", "8 couleurs vives", "Sac de rangement premium", "20 modèles d'inspiration", "Accès communauté VIP", "Certifié CE & EN 71", "Emballage cadeau luxe", "Livraison prioritaire"],
    cta: "Choisir ce pack",
    highlight: false,
