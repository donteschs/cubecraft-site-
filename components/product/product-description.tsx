...
export function ProductDescription({ product }: { product: Product }) {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Description produit — section pliable */}
      {product.descriptionHtml ? (
        <details className="group mt-8 border-t border-pierre/10 pt-4">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-2 py-2 font-rubik font-bold text-pierre">
            Description &amp; caractéristiques
            <svg
              className="h-5 w-5 flex-shrink-0 text-pierre/50 transition-transform duration-200 group-open:rotate-180"
              viewBox="0 0 20 20"
              fill="currentColor"
              aria-hidden
            >
          ...
          <Prose
            className="mt-2 text-sm leading-relaxed text-pierre/80"
